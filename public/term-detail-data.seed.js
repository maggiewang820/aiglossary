  ...
  const HOTWORD_HISTORY = {
        ...
        "2026-06-24": [
          ...
          },
          {
            ...
            link: "https://google.github.io/adk-docs/agents/multi-agents/",
        ...
        "2026-06-27": [
          {
            ...
            sourceLabel: "Google ADK Docs",
            related: ["AI Agent", "Task", "Multi-agent System"],
            score: 91,
          ...
          },
          {
            ...
            related: ["Reasoning Model", "Tool Use", "Chain of Thought"],
            score: 87,
          ...
          },
          {
            ...
            related: ["Agentic Workflow", "AI Workflow", "Task"],
            score: 83,
          ...
          },
          {
            ...
            sourceLabel: "LangGraph Docs",
            related: ["Verifier", "AI Agent", "Scaffolding"],
            score: 79,
          ...
          },
          {
            ...
            related: ["RAG", "Embedding", "AI Benchmarks"],
            score: 70,
          ...
          },
          {
            ...
            related: ["Prompt Engineering", "RAG", "Semantic Analysis"],
            score: 67,
          ...
          },
          {
            ...
            related: ["RAG", "Hallucination", "AI Safety"],
            score: 64,
          ...
          },
          {
            ...
            sourceLabel: "LangGraph Docs",
            related: ["AI Agent", "Context Engineering", "AI Workflow"],
            score: 61,
        ...
        "2026-06-28": [
          {
            ...
            related: ["Reasoning Model", "Inference", "Scaling Laws"],
            score: 92,
          ...
          },
          {
            ...
            source: "OpenAI / 过程监督",
            sourceLabel: "OpenAI Research",
            related: ["Reward Model", "Reasoning Model", "Verifier"],
            score: 88,
          ...
          },
          {
            ...
            related: ["Reinforcement Learning", "RLHF", "Reward"],
            score: 84,
          ...
          },
          {
            ...
            sourceLabel: "IBM Think",
            related: ["Model", "Training Data", "Inference"],
            score: 80,
          ...
          },
          {
            ...
            related: ["RAG", "Knowledge Graph", "Vector Database"],
            score: 77,
          ...
          },
          {
            ...
            related: ["Explainable AI", "Neural Network", "Weights"],
            score: 73,
            scoreBreakdown: "覆盖 19 · 频次 16 · 权重 16 · 位置 12 · 术语 10"
          },
          {
            ...
            source: "Anthropic / 机制解释性",
            sourceLabel: "Anthropic Research",
            related: ["Explainable AI", "Neural Network", "Transformer"],
            score: 70,
            scoreBreakdown: "覆盖 18 · 频次 15 · 权重 15 · 位置 12 · 术语 10"
          },
          {
            ...
            sourceLabel: "Hugging Face Docs",
            related: ["LoRA", "Fine-tuning", "Weights"],
            score: 67,
            scoreBreakdown: "覆盖 17 · 频次 14 · 权重 15 · 位置 11 · 术语 10"
          },
          {
            ...
            related: ["AI Benchmarks", "LLM", "Model"],
            score: 64,
            scoreBreakdown: "覆盖 16 · 频次 13 · 权重 15 · 位置 10 · 术语 10"
          },
          {
            ...
            related: ["AI Safety", "AI Ethics", "Guardrails"],
            score: 61,
            scoreBreakdown: "覆盖 15 · 频次 13 · 权重 14 · 位置 9 · 术语 10"
          }
        ],
        "2026-06-29": [
          {
            ...
            sourceLabel: "Anthropic",
            related: ["AI Agent", "Tool Use", "AI Browser"],
            score: 96,
          ...
          },
          {
            ...
            related: ["AI Agent", "Tool Use", "Computer-Using Agent"],
            score: 92,
          ...
          },
          {
            ...
            related: ["AI Agent", "Tool Use", "Vibe Coding"],
            score: 84,
          ...
          },
          {
            ...
            related: ["AI Agent", "Context Window", "Task"],
            score: 73,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI SDK Docs",
            related: ["Guardrails", "Tool Calling", "AI Safety"],
            score: 70,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Docs",
            related: ["AI Benchmarks", "AI Agent", "Guardrails"],
            score: 67,
        ...
        "2026-06-30": [
          ...
          },
          {
            ...
            sourceLabel: "MCP Docs",
            related: ["MCP", "Tool Calling", "Structured Outputs"],
            score: 92,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI SDK Docs",
            related: ["AI Agent", "Agent Evals", "Tool Guardrails"],
            score: 88,
          ...
          },
          {
            ...
            related: ["Inference", "Token", "Prompt Caching"],
            score: 84,
          ...
          },
          {
            ...
            sourceLabel: "vLLM Docs",
            related: ["Prompt Caching", "Inference", "Token"],
            score: 80,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Docs",
            related: ["AI Benchmarks", "Agent Evals", "Reward Model"],
            score: 77,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI SDK Docs",
            related: ["AI Agent", "Multi-agent System", "Workflow Agent"],
            score: 73,
          ...
          },
          {
            ...
            related: ["Agent Tracing", "Agent Evals", "AI Agent"],
            score: 70,
          ...
          },
          {
            ...
            sourceLabel: "IBM Think",
            related: ["Training Data", "Data Augmentation", "Fine-tuning"],
            score: 67,
          ...
          },
          {
            ...
            sourceLabel: "NIST",
            related: ["AI Safety", "AI Ethics", "AI Red Teaming"],
            score: 64,
        ...
        "2026-07-01": [
          ...
          },
          {
            ...
            source: "OpenAI Evals / 评测实践 / 中文技术讨论",
            sourceLabel: "OpenAI Docs",
            related: ["AI Benchmarks", "Responsible AI", "Prompt Engineering"],
            score: 92,
          ...
          },
          {
            ...
            sourceLabel: "Browser Use",
            related: ["AI Agent", "Tool Use", "Computer Vision"],
            score: 89,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Docs",
            related: ["AI Benchmarks", "Prompt Engineering", "Responsible AI"],
            score: 85,
          ...
          },
          {
            ...
            source: "MCP 规范 / GitHub 动态 / 中文开发者社区",
            sourceLabel: "MCP Docs",
            related: ["MCP", "Tool Use", "AI Workflow"],
            score: 81,
          ...
          },
          {
            ...
            sourceLabel: "MCP Docs",
            related: ["MCP", "Prompt Engineering", "Tool Use"],
            score: 77,
          ...
          },
          {
            ...
            sourceLabel: "Hugging Face Docs",
            related: ["Inference", "Transformer", "Token"],
            score: 73,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Docs",
            related: ["Reasoning Model", "Token", "Chain of Thought"],
            score: 69,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Docs",
            related: ["Reasoning Model", "Token", "Prompt Engineering"],
            score: 65,
          ...
          },
          {
            ...
            sourceLabel: "Anthropic",
            related: ["AI Agent", "Computer Vision", "Tool Use"],
            score: 61,
        ...
        "2026-07-02": [
          ...
          },
          {
            ...
            sourceLabel: "Anthropic",
            related: ["Computer Using Agent", "AI Agent", "Tool Use"],
            score: 91,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI SDK Docs",
            related: ["Sandboxed Execution", "AI Agent", "Tool Use"],
            score: 83,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI SDK Docs",
            related: ["Context Window", "AI Agent", "Prompt Engineering"],
            score: 75,
          ...
          },
          {
            ...
            source: "Anthropic / GUI 自动化讨论 / 中文科技媒体",
            sourceLabel: "Anthropic",
            related: ["Computer Using Agent", "AI Agent", "Computer Vision"],
            score: 71,
          ...
          },
          {
            ...
            sourceLabel: "MCP Docs",
            related: ["Tool Use", "Structured Outputs", "MCP"],
            score: 68,
          ...
          },
          {
            ...
            sourceLabel: "Browser Use",
            related: ["Browser Agent", "AI Agent", "Tool Use"],
            score: 64,
          ...
          },
          {
            ...
            source: "arXiv / 开源生态 / 开发者社区",
            sourceLabel: "arXiv",
            related: ["Tool Use", "AI Agent", "Computer Vision"],
            score: 60,
        ...
        "2026-07-03": [
          ...
          },
          {
            ...
            sourceLabel: "MCP Docs",
            related: ["MCP Resources", "Prompt", "Tool Use"],
            score: 79,
          ...
          },
          {
            ...
            source: "MCP 规范 / 开源工具链 / 中文开发者社区",
            sourceLabel: "MCP Docs",
            related: ["Prompt", "Prompt Engineering", "MCP"],
            score: 75,
          ...
          },
          {
            ...
            related: ["Human-in-the-Loop", "AI Agent", "Tool Use"],
            score: 71,
          ...
          },
          {
            ...
            related: ["Tool Use", "AI Agent", "Context Management"],
            score: 67,
          ...
          },
          {
            ...
            related: ["Prompt Injection", "Tool Use", "AI Safety"],
            score: 63,
          ...
          },
          {
            ...
            related: ["Tool Poisoning", "AI Safety", "Guardrails"],
            score: 59,
        ...
        "2026-07-06": [
          ...
          },
          {
            ...
            related: ["A2A", "AI Agent", "Workflow Agent"],
            score: 84,
          ...
          },
          {
            ...
            sourceLabel: "AG-UI Docs",
            related: ["AG-UI", "Run Context", "Structured Outputs"],
            score: 80,
          ...
          },
          {
            ...
            sourceLabel: "MCP Docs",
            related: ["MCP", "Tool Guardrails", "AI Safety"],
            score: 78,
          ...
          },
          {
            ...
            related: ["Context Window", "Long Context", "RAG"],
            score: 76,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Docs",
            related: ["Structured Outputs", "Token", "Guardrails"],
            score: 72,
          ...
          },
          {
            ...
            related: ["Training Data", "Responsible AI", "AI Safety"],
            score: 70,
          ...
          },
          {
            ...
            sourceLabel: "arXiv",
            related: ["Agent Memory", "Tool Poisoning", "AI Safety"],
            score: 68,
        ...
        "2026-07-07": [
          {
            ...
            related: ["MCP", "MCP Tools", "MCP Resources"],
            score: 94,
          ...
          },
          {
            ...
            related: ["MCP Authorization", "MCP", "AI Safety"],
            score: 90,
          ...
          },
          {
            ...
            related: ["MCP Authorization", "MCP", "AI RMF"],
            score: 86,
          ...
          },
          {
            ...
            related: ["Tool Guardrails", "Tool Use", "AI Safety"],
            score: 82,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Agents SDK",
            related: ["Run Context", "Context Variables", "MCP Tools"],
            score: 78,
          ...
          },
          {
            ...
            related: ["AI Workflow", "Tool Use", "Agent Observability"],
            score: 74,
          ...
          },
          {
            ...
            related: ["Agent State", "Short-term Memory", "Workflow Agent"],
            score: 70,
          ...
          },
          {
            ...
            related: ["Agent State", "Context Variables", "AI Agent"],
            score: 66,
          ...
          },
          {
            ...
            related: ["Multi-agent System", "Sequential Workflow", "Agentic Workflow"],
            score: 62,
          ...
          },
          {
            ...
            related: ["Tool Poisoning", "Prompt Injection", "AI Safety"],
            score: 58,
        ...
        "2026-07-08": [
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Research",
            related: ["AI Alignment", "AI Safety", "Reasoning Model"],
            score: 88,
          ...
          },
          {
            ...
            related: ["Reasoning Model", "Verifier", "Reward Model"],
            score: 84,
          ...
          },
          {
            ...
            sourceLabel: "Anthropic Research",
            related: ["Activation Steering", "AI Safety", "Transformer"],
            score: 78,
          ...
          },
          {
            ...
            related: ["Short-term Memory", "Semantic Memory", "RAG"],
            score: 69,
        ...
        "2026-07-09": [
          {
            ...
            related: ["AI Agent", "Human-in-the-Loop", "AI Workflow"],
            score: 95,
          ...
          },
          {
            ...
            related: ["Coding Agent", "AI Agent", "Human-in-the-Loop"],
            score: 92,
          ...
          },
          {
            ...
            related: ["AI Safety", "AI Benchmarks", "Tool Guardrails"],
            score: 86,
          ...
          },
          {
            ...
            related: ["AI Workflow", "Agent Observability", "Evals"],
            score: 79,
          ...
          },
          {
            ...
            related: ["Evals", "Agent Observability", "AI Workflow"],
            score: 75,
          ...
          },
          {
            ...
            related: ["Long-term Memory", "Short-term Memory", "RAG"],
            score: 72,
          ...
          },
          {
            ...
            related: ["Long-term Memory", "Agent State", "Context Engineering"],
            score: 68,
          ...
          },
          {
            ...
            sourceLabel: "HAS-Bench Paper",
            related: ["Human-in-the-Loop", "AI Agent", "AI Workflow"],
            score: 64,
        ...
        "2026-07-11": [
          ...
          },
          {
            ...
            source: "Active Memory Navigation / arXiv / Agent 记忆讨论 / 中文技术社区",
            sourceLabel: "Active Memory Navigation Paper",
            related: ["RAG", "Context Window", "AI Agent"],
            score: 88,
          ...
          },
          {
            ...
            sourceLabel: "Active Memory Navigation Paper",
            related: ["RAG", "AI Agent", "Context Window"],
            score: 85,
          ...
          },
          {
            ...
            related: ["Rollout", "Agent Evals", "Tracing"],
            score: 82,
          ...
          },
          {
            ...
            related: ["Rollout", "Training Data", "Tool Use"],
            score: 78,
          ...
          },
          {
            ...
            related: ["Tracing", "Agent Observability", "AI Workflow"],
            score: 75,
          ...
          },
          {
            ...
            sourceLabel: "BenchAgent Paper",
            related: ["AI Workflow", "AI Agent", "Tool Use"],
            score: 66,
          ...
          },
          {
            ...
            sourceLabel: "BenchAgent Paper",
            related: ["AI Agent", "Evals", "Tool Use"],
            score: 63,
        ...
        "2026-07-13": [
          ...
          },
          {
            ...
            sourceLabel: "NIST AI Agent Standards",
            related: ["AI Agent", "Policy", "Tracing"],
            score: 90,
          ...
          },
          {
            ...
            related: ["Tool Guardrails", "AI Safety", "Policy"],
            score: 87,
          ...
          },
          {
            ...
            related: ["Checkpointer", "Session State", "AI Workflow"],
            score: 84,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Agents SDK",
            related: ["Tool Approval", "Human-in-the-Loop", "Guardrails"],
            score: 80,
          ...
          },
          {
            ...
            related: ["Verifier", "Reward Model", "AI Workflow"],
            score: 77,
          ...
          },
          {
            ...
            sourceLabel: "Anthropic Engineering",
            related: ["Handoffs", "Task Decomposition", "AI Workflow"],
            score: 74,
          ...
          },
          {
            ...
            link: "https://www.rfc-editor.org/rfc/rfc8707.html",
            source: "IETF / MCP 授权讨论 / 中文安全社区 / 企业架构论坛",
            sourceLabel: "IETF RFC 8707",
            related: ["MCP Authorization", "Protected Resource Metadata", "AI Agent Identity"],
            score: 71,
          ...
          },
          {
            ...
            related: ["Tracing", "Agentic Provenance", "Agent Observability"],
            score: 68,
          ...
          },
          {
            ...
            sourceLabel: "OWASP LLM Top 10",
            related: ["Inference", "AI Safety", "Tool Guardrails"],
            score: 65,
        ...
        "2026-07-14": [
          {
            ...
            sourceLabel: "Agent Memory Paper",
            related: ["Long-term Memory", "Agent-Native Memory System", "RAG"],
            score: 96,
          ...
          },
          {
            ...
            sourceLabel: "Google AI Glossary",
            related: ["AI Agent", "Agentic Workflow", "Multi-agent System"],
            score: 93,
          ...
          },
          {
            ...
            sourceLabel: "IBM Think",
            related: ["RAG", "Agentic RAG", "Tool Use"],
            score: 90,
          ...
          },
          {
            ...
            related: ["Inference", "Reasoning Model", "Test-Time Compute"],
            score: 87,
          ...
          },
          {
            ...
            sourceLabel: "Google AI Glossary",
            related: ["Reward Model", "AI Safety", "RLHF"],
            score: 84,
          ...
          },
          {
            ...
            sourceLabel: "IETF RFC 9728",
            related: ["MCP Authorization", "Protected Resource Metadata", "Resource Indicator"],
            score: 81,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Docs",
            related: ["Structured Outputs", "Tool Calling", "Tool Use"],
            score: 78,
          ...
          },
          {
            ...
            related: ["Tool Use", "Computer Use", "Tool Approval"],
            score: 75,
          ...
          },
          {
            ...
            sourceLabel: "LangChain Memory",
            related: ["Long-term Memory", "RAG", "Context Engineering"],
            score: 72,
          ...
          },
          {
            ...
            related: ["Task Decomposition", "Agentic Workflow", "AI Agent"],
            score: 69,
        ...
        "2026-07-15": [
          {
            ...
            sourceLabel: "MCP Authorization Spec",
            related: ["MCP", "OAuth Resource Metadata", "Resource Indicator"],
            score: 96,
            scoreBreakdown: "覆盖 30 · 频次 25 · 权重 18 · 位置 13 · 术语 10"
          },
          {
            ...
            sourceLabel: "IETF RFC 9728",
            related: ["OAuth Resource Metadata", "MCP Authorization", "Resource Indicator"],
            score: 93,
            scoreBreakdown: "覆盖 29 · 频次 24 · 权重 18 · 位置 13 · 术语 9"
          },
          {
            ...
            sourceLabel: "OpenAI Agents SDK",
            related: ["Guardrails", "Tool Guardrails", "AI Safety"],
            score: 90,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Agents SDK",
            related: ["Guardrails", "Structured Outputs", "AI Safety"],
            score: 87,
          ...
          },
          {
            ...
            sourceLabel: "OWASP LLM Top 10",
            related: ["AI Safety", "Prompt Injection", "Tool Guardrails"],
            score: 84,
            scoreBreakdown: "覆盖 26 · 频次 21 · 权重 17 · 位置 11 · 术语 9"
          },
          {
            ...
            sourceLabel: "OWASP LLM Top 10",
            related: ["AI Safety", "Tool Poisoning", "AI Red Teaming"],
            score: 81,
          ...
          },
          {
            ...
            sourceLabel: "LangSmith Docs",
            related: ["Agent Evals", "Agent Tracing", "AI Benchmarks"],
            score: 75,
          ...
          },
          {
            ...
            sourceLabel: "NIST AI RMF",
            related: ["AI RMF", "Responsible AI", "AI Safety"],
            score: 69,
        ...
        "2026-07-16": [
          {
            ...
            related: ["MCP","MCP Authorization","Tool Use"]
          },
          {
            rank: 2,
            ...
            related: ["Tool Use","Sandboxed Tool Use","MCP Authorization"]
          },
          {
            rank: 3,
            ...
            related: ["Evaluation Trace","LLM-as-a-Judge","AI Agent"]
          },
          {
            rank: 4,
            ...
            related: ["Evaluation Trace","Agent Audit Log","Agent Evaluation"]
          },
          {
            rank: 5,
            ...
            related: ["Indirect Prompt Injection","Vector and Embedding Weaknesses","Input Guardrails"]
          },
          {
            rank: 6,
            ...
            related: ["AI Risk Measurement","Output Guardrails","AI Safety"]
          },
          {
            rank: 7,
            english: "RLVR",
            ...
            related: ["Reinforcement Learning","Reward Model","Reasoning Model"]
          },
          {
            rank: 8,
            ...
            related: ["Inference","KV Cache","Disaggregated Prefill"]
          },
          {
            rank: 9,
            ...
            related: ["Autoencoder","AI Safety","Neural Network"]
          },
          {
            rank: 10,
            english: "Activation Steering",
            ...
            related: ["Sparse Autoencoder","AI Safety","Neural Network"]
          }
        ],
        "2026-07-17": [
          {
            ...
            related: ["AI Alignment","AI Safety","Agent Evaluation"],
            score: 96,
          ...
          },
          {
            ...
            related: ["Agent Audit Log","Agent Observability","AI Safety"],
            score: 93,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Agents SDK",
            related: ["Guardrails","Input Guardrails","Tool Guardrails"],
            score: 90,
          ...
          },
          {
            ...
            sourceLabel: "LangChain Docs",
            related: ["Human-in-the-Loop","Human Approval Gate","Tool Approval"],
            score: 87,
          ...
          },
          {
            ...
            sourceLabel: "LangChain Docs",
            related: ["HITL Middleware","Human Approval Gate","Tool Approval"],
            score: 84,
          ...
          },
          {
            ...
            sourceLabel: "MCP Specification",
            related: ["MCP Tools","Structured Outputs","Tool Result"],
            score: 81,
          ...
          },
          {
            ...
            sourceLabel: "MCP Specification",
            related: ["MCP","Resource Templates","Tool Result"],
            score: 78,
          ...
          },
          {
            ...
            sourceLabel: "NVIDIA Glossary",
            related: ["AI Safety","Inference","RAG"],
            score: 75,
          ...
          },
          {
            ...
            sourceLabel: "arXiv",
            related: ["Reinforcement Learning","Tool Use","Agentic Misalignment"],
            score: 72,
          ...
          },
          {
            ...
            sourceLabel: "OpenAI Agents SDK",
            related: ["Agent Tracing","Tracing","Agent Observability"],
            score: 69,
